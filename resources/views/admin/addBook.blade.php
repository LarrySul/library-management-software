					...
					<form role="form" method="post" action="/upload" enctype="multipart/form-data">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="author" placeholder="Enter author's name" maxlength="15" required>
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">Book title</label>
								<input type="text" class="form-control" name="title" placeholder="Enter Book's title" required>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="year" placeholder="Enter year of publication" required>
							</div>
							<div class="form-group">
								<div class="form-group">
							...
							<div class="form-group">
								<label for="exampleInputFile">Upload Book Image</label>
